...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="text-gray-800">Lab Results</h1>
      </div>
      <div class="col-sm-6">
      ...
      <div class="col-12">
        <div class="card shadow">
          <div class="card-header">
            <span class="card-title h6 font-weight-bold text-primary">Lab Results table</span>
          ...
          <div class="card-body table-responsive">
            <table id="generalTable" class="table table-borderless table-striped table-sm" style="border-radius: 3px; overflow: hidden;">
              <thead class="thead-dark">
                <tr>
                  <th @if (Session::get('role') == 'pchem_manager' OR Session::get('role') == 'micro_manager' OR Session::get('role') == 'super_admin')
                  @else style="display:none;" @endif>Action</th>
                  <th>Account Name</th>
                  <th>Unit No Floor Bldg Name</th>
                  <th>Stree Name Or Subdivision</th>
                  <th>Barangay Name</th>
              ...
              <tbody class="font-weight-light">
                <tr class="mx-md-n5">
                  ...
                  <td @if (Session::get('role') == 'pchem_manager' OR Session::get('role') == 'micro_manager' OR Session::get('role') == 'super_admin')
