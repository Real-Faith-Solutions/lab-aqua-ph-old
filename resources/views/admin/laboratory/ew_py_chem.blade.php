...
<section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="text-gray-800">Environmental Water - Py Chem</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Record</a></li>
            <li class="breadcrumb-item active">Environmental Water - Py Chem</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
          <div class="card shadow">
            <div class="card-header">
                <span class="card-title h6 font-weight-bold text-primary">Environmental Water - Py Chem table</span>
            ...
            <div class="card-body table-responsive">
                ...
                <tr>
                    ...
                    <th>Instrument Reading 1</th>
                    <th>Instrument Reading 2</th>
                    <th>Instrument Reading 3</th>
                    <th>Average Instrument Reading</th>
                    <th>Final Result</th>
