          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Collections Data table</h3> 
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><b style="color: blue">30.99</b></td>
                    <td><b style="color: blue">300.99</b></td>
                    <td><button type="button" class="btn btn-danger btn-xs">Latepayment</button></td>
                   ...
                   <td><b style="color: maroon">7545</b></td>
                    ...
                    <td><b style="color: blue">30.99</b></td>
                    <td><b style="color: blue">300.99</b></td>
                    <td><button type="button" class="btn btn-success btn-xs">Overpayment</button></td>
                    <td><button class="btn btn-primary btn-xs" data-toggle="modal" data-target="#edit"><i class="fa fa-edit"></i></button> <button class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></button></td>
                  </tr>
